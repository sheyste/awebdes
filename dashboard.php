...
<?php
  ...
  $getdata = mysqli_query($con, "SELECT tblstudents.*, tblaccounts.username, tblaccounts.password FROM tblstudents JOIN tblaccounts ON tblstudents.studID = tblaccounts.studID");
  if(!$getdata){
    die(mysqli_error());
  }
					  ...
					  while($row = mysqli_fetch_array($getdata)){ ?>
						<tr>
							...
							<td>
								...
								<a style="text-decoration:none;" href="update.php?studID=<?php echo $row['studID']; ?>"><i class="bi bi-pencil-fill"></i></a>
								<a href="delete.php?studID=<?php echo $row['studID']; ?>"><i class="bi bi-trash-fill"></i></a>
							</td>
						</tr>
